<html>
    <head>
     ...
     <body>
        ...
        <h4 align="center">
       <form action="https://p9056.isrcttu.net/20200413/calendar.php" method="post" style="font-size:16px; line-height:150%;">
         <select name="choose1">
          <?php
    ...
    <body>
        <div style="color:white; background-color:#8DAA9D; height:100%;  padding:20px ">
          ...
          for($i=0;$i<7;$i++){
            ...
            ?>  
                <td width="25" <?php echo $BgColor; ?> > <?php echo $Date;  ?></td>
           <?php }   ?>
